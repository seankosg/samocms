        ...
        messages: [
          {
            ...
            content:
              ...
              "형식: 정확히 5개 문단, 각 문단 2~3문장, 전체 900자 이내. 각 문단은 반드시 '[진도] ', '[공종] ', '[리스크] ', '[전망] ', '[조치] ' 중 하나의 라벨로 시작합니다(순서 고정). " +
              "강조: 핵심 수치와 핵심 키워드(지연 건수, 격차, 위험 마일스톤, 문제 협력사·건물명, 예측 완료일, 권고 조치)는 **이렇게** 이중 별표로 감쌉니다. 문단당 2~4개만 강조하고, 그 외 마크다운 기호(#, -, 목록)는 쓰지 않습니다. " +
              "내용: [진도] 기준일 기준 전체 진도와 계획 대비 격차, [공종] 공종별 강·약점, [리스크] 지연 집중 영역(건물·협력사)과 마일스톤 리스크, " +
              "[전망] '[진행도 예측]' 자료를 근거로 현재 속도 유지 시 전체 예상 완료 시점과 계획 대비 선행·지연 일수, 가장 크게 지연될 공종·마일스톤·시운전 단계, " +
              "[조치] 시운전(T&C) T1·T2 현황과 권고 조치. " +
              "예측 자료가 제공되지 않았거나 값이 '—'인 항목은 언급하지 말고, 그 경우 [전망] 문단은 예측 불가 사유를 1문장으로 적습니다. " +
